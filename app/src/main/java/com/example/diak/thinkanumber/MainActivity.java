...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alert_vesztett.setTitle("Sajnálom vesztettél")         //Cím adás
                .setMessage("Újra akarod kezdeni a játékot?")       //Kérdés amit felteszünk.
                .setPositiveButton("Nem", new DialogInterface.OnClickListener() {     //Pozitív gomb = jobb oldali gomb
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
        ...
        //BTN_PLUS ESEMÉNY ÍRÁS: ha rá klikkelünk akkor a tipplet_szam értékét növeljük.
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (eletpont>0) {
                            ...
                            eletpont = eletpont - 1;
                            Toast.makeText(MainActivity.this, "Már csak " + eletpont + " életpontod maradt!", Toast.LENGTH_SHORT).show();
                        }else
                        alert_vesztett.show();
                    }
               }
